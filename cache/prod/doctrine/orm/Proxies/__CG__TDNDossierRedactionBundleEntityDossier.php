...
namespace Proxies\__CG__\TDN\DossierRedactionBundle\Entity;

/**
 * THIS CLASS WAS GENERATED BY THE DOCTRINE ORM. DO NOT EDIT THIS FILE.
 */
class Dossier extends \TDN\DossierRedactionBundle\Entity\Dossier implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'titre', 'slug', 'abstract', 'likes', 'hits', 'tags', 'statut', 'commentThread', 'datePublication', 'dateModification', 'version', 'v2ID', 'v1ID', 'ordreDossier', 'idDocument', 'lnPromu', 'commentaires', 'lnAuteur', 'lnIllustration', 'lnThematique', 'lnDossier', 'rubriques', 'analogues', 'filTags', 'fascicule');
    }
