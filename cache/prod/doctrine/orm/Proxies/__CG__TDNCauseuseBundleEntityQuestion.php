...
namespace Proxies\__CG__\TDN\CauseuseBundle\Entity;

/**
 * THIS CLASS WAS GENERATED BY THE DOCTRINE ORM. DO NOT EDIT THIS FILE.
 */
class Question extends \TDN\CauseuseBundle\Entity\Question implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addFilReponse($filReponses);
    }

    public function removeFilReponse(\TDN\CauseuseBundle\Entity\Reponse $filReponses)
    {
        $this->__load();
        return parent::removeFilReponse($filReponses);
    }

    public function getFilReponses()
    {
        $this->__load();
        return parent::getFilReponses();
    }
    ...
    {
        $this->__load();
        return parent::setReponseAcceptee($reponseAcceptee);
    }

    public function getReponseAcceptee()
    {
        $this->__load();
        return parent::getReponseAcceptee();
    }
    ...
    {
        return array('__isInitialized__', 'titre', 'slug', 'abstract', 'likes', 'hits', 'tags', 'statut', 'commentThread', 'datePublication', 'dateModification', 'version', 'v2ID', 'v1ID', 'ordreDossier', 'idDocument', 'lnPromu', 'commentaires', 'lnAuteur', 'lnIllustration', 'lnThematique', 'lnDossier', 'rubriques', 'analogues', 'filTags', 'question', 'dateSoumission', 'reponseAcceptee', 'filReponses');
    }
