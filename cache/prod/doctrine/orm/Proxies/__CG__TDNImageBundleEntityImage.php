...
namespace Proxies\__CG__\TDN\ImageBundle\Entity;

/**
 * THIS CLASS WAS GENERATED BY THE DOCTRINE ORM. DO NOT EDIT THIS FILE.
 */
class Image extends \TDN\ImageBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::storeUpload();
    }

    public function storeUploadCustom($path)
    {
        $this->__load();
        return parent::storeUploadCustom($path);
    }
    ...
    {
        $this->__load();
        return parent::init($storage, $owner, $auteur);
    }

    public function scale($width, $height, $fit)
    {
        $this->__load();
        return parent::scale($width, $height, $fit);
    }
    ...
    {
        return array('__isInitialized__', 'titre', 'slug', 'abstract', 'likes', 'hits', 'tags', 'statut', 'commentThread', 'datePublication', 'dateModification', 'version', 'v2ID', 'v1ID', 'ordreDossier', 'idDocument', 'lnPromu', 'commentaires', 'lnAuteur', 'lnIllustration', 'lnThematique', 'lnDossier', 'rubriques', 'analogues', 'filTags', 'fichier', 'alt', 'mimeType', 'idOwner');
    }
