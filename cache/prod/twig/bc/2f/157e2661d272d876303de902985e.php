...
/* DossierRedactionBundle:Bloc:blocDossierSidebar.html.twig */
class __TwigTemplate_bc2f157e2661d272d876303de902985e extends Twig_Template
{
...
\t\t<img src=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("assets/images/theme/sidebar/cadre_pince_dossier.png"), "html", null, true);
        echo "\" />
\t</a>
\t";
        // line 5
        if ((!twig_test_empty($this->getContext($context, "dossier")))) {
            // line 6
            echo "\t<ul>
\t\t<li>
\t\t\t<a href=\"";
            // line 8
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("DossierRedaction_dossier", array("id" => $this->getAttribute($this->getContext($context, "dossier"), "idDocument"), "slug" => $this->getAttribute($this->getContext($context, "dossier"), "slug"), "rubrique" => $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "dossier"), "rubriques"), 0, array(), "array"), "slug"))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "dossier"), "titre"), "html", null, true);
            echo "</a>
\t\t</li>
\t</ul>
\t";
            ...
            // line 12
            echo "\t<p>Aucun dossier en ligne</p>
\t";
        }
        // line 14
        echo "\t<a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("DossierRedaction_sommaire"), "html", null, true);
        echo "\">Tous les dossiers</a>
</div>
<img src=\"";
        // line 16
...
";
    ...
    {
        return "DossierRedactionBundle:Bloc:blocDossierSidebar.html.twig";
    }
