...
abstract class Document
{
     ...
     * Set lnThematique
     *
     * @param TDN\DocumentBundle\Entity\DocumentRubrique
     * @return Document
     */
    ...
    public function assigneRubriques($collection) {
        ...
        if (!empty($listeRubriques)) {
            ...
            $bufferRubriques[] = $principale->getRubrique()->getIdRubrique();
            print_r($principale->getRubrique()->getTitre());
            foreach($listeRubriques as $r) {
                $rubrique = $r->getRubrique();
                if (!(in_array($rubrique->getIdRubrique(), $bufferRubriques))) {
                    $this->addRubrique($rubrique);
                    $bufferRubriques[] = $rubrique->getIdRubrique();
                    print_r($rubrique->getTitre());
                }
            }
        }
        return $this;
     ...
     *
     * @param TDN\DocumentBundle\Entity\DocumentRubrique $collection
     */
    ...
    public function getURLElements() {
        ...
        // $is_Document = is_subclass_of(get_class($rubrique), 'TDN\DocumentBundle\Entity\Document');
