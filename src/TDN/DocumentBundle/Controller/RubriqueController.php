...
use TDN\DocumentBundle\Form\Type\modifyRubriqueType;
use TDN\DocumentBundle\Form\Type\defineRubriqueType;
...
class RubriqueController extends Controller
{
    ...
    public function indexAction() {
		...
		$variables['Liste'] = $em->getRepository('TDN\DocumentBundle\Entity\DocumentRubrique')->findTop();

        return $this->render('DocumentBundle:Rubrique:dashboard.html.twig', $variables);
    }
    ...
    public function creerAction() {
        ...
        return $this->render('DocumentBundle:Rubrique:creerRubrique.html.twig', $variables);
    }
    ...
    public function modifierAction($id) {
		...
		$request = $this->get('request');
		$em = $this->get('doctrine.orm.entity_manager');
		$rubrique = $em->getRepository('TDN\DocumentBundle\Entity\DocumentRubrique')->find($id);
        ...
        return $this->render('DocumentBundle:Rubrique:majRubrique.html.twig', $variables);
    }
    ...
    public function mainNavigationAction () {
        ...
        return $this->render('CoreBundle:Bloc:mainNavigation.html.twig', $_vars);
