...
/**
 * TDN\ConcoursBundle\Entity\Concours
 */
class Concours extends Document {
     ...
     * Add questions
     *
     * @param TDN\ConcoursBundle\Entity\ConcoursQuestion $questions
     * @return Concours
     */
    public function addQuestion(\TDN\ConcoursBundle\Entity\ConcoursQuestion $questions)
    {
     ...
     * @return Concours
     */
    public function addQuestionBack(\TDN\ConcoursBundle\Entity\ConcoursQuestion $question)
    {
     ...
     * @param TDN\ConcoursBundle\Entity\ConcoursQuestion $questions
     */
    public function removeQuestion(\TDN\ConcoursBundle\Entity\ConcoursQuestion $questions)
    {
     ...
     * Add participants
     *
     * @param TDN\NanaBundle\Entity\Nana $participants
     * @return Concours
     */
    public function addParticipant(\TDN\NanaBundle\Entity\Nana $participants)
    {
     ...
     * @param TDN\NanaBundle\Entity\Nana $participants
     */
    public function removeParticipant(\TDN\NanaBundle\Entity\Nana $participants)
    {
     ...
     * Add filParticipants
     *
     * @param TDN\ConcoursBundle\Entity\ConcoursParticipant $filParticipants
     * @return Concours
     */
    public function addFilParticipant(\TDN\ConcoursBundle\Entity\ConcoursParticipant $filParticipants)
    {
     ...
     * @param TDN\ConcoursBundle\Entity\ConcoursParticipant $filParticipants
     */
    public function removeFilParticipant(\TDN\ConcoursBundle\Entity\ConcoursParticipant $filParticipants)
    {
