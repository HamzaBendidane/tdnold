...
class WSController extends Controller {
    ...
    protected function _getOneContenu (array $entite, $id) {
        ...
        if (!is_object($_contenu)) {
            $ack = json_encode(array('reponse' => 'ERRNODOC'));
            $response = new Response($ack);
        } else {
    ...
    public function iOSFeaturedAction ()
    {
        ...
        $flux_articles = $resultats;

        return new JsonResponse(array('featured' => $flux_featured, 'articles' => $flux_articles));
    }
