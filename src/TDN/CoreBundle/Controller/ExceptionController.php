...
class ExceptionController extends ContainerAware
{
    ...
    protected function getAndCleanOutputBuffering()
    {
        ...
        // $_contexte= $this->container->get('security.context');
        // $_usr= $_contexte->getToken()->getUser();
        // $_admin = $_contexte->isGranted('ROLE_ADMIN');
        // $_journaliste = $_contexte->isGranted('ROLE_JOURNALISTE');
        // $is_admin_authorized = $_admin || $_journaliste;

        // $name = ($îs_admin_authorized) ? 'exception' : 'error';
