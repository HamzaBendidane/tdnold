...
class simpleScanner {
	...
	x','37.46.80.170','37.59.32.148','37.187.x.x','37.233.27.142','41.32.127.206','41.79.x.x','41.86.227.22','41.86.234.x','41.86.235.x',
	...
	07.6.70','91.207.7.x','91.236.x.x','92.222.239.56','93.10.27.49','93.115.94.85','94.23.238.222','95.211
	...
	4.34','125.78.x.x','125.85.13.21','130.193.24.135','140.237.x.x','142.0.136.x','142.54.176.138','162.244.13.x','173.208.182.74','183.5.141.244','183.1
    ...
    private function isNotValidAntiSpam($reponse)
    {
    	if (is_null($reponse)) {
	    	...
	    	return !in_array($reponse, $this->validesAntiSpam);
    	}
    }
