...
/**
 * TDN\NanaBundle\Entity\NanaHobby
 */
class NanaHobby
{
    /**
     ...
     * Add galerieHobby
     *
     * @param TDN\NanaBundle\Entity\NanaHobbyImageProxy $galerieHobby
     * @return NanaHobby
     */
    public function addGalerieHobby(\TDN\NanaBundle\Entity\NanaHobbyImageProxy $galerieHobby)
    {
     ...
     * @param TDN\NanaBundle\Entity\NanaHobbyImageProxy $galerieHobby
     */
    public function removeGalerieHobby(\TDN\NanaBundle\Entity\NanaHobbyImageProxy $galerieHobby)
    {
     ...
     * Set lnOwner
     *
     * @param TDN\NanaBundle\Entity\Nana $lnOwner
     * @return NanaHobby
     */
    public function setLnOwner(\TDN\NanaBundle\Entity\Nana $lnOwner = null)
    {
