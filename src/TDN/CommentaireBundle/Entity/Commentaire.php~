...
namespace TDN\CommentaireBundle\Entity;

use Doctrine\ORM\Mapping as ORM;

/**
 * TDN\CommentaireBundle\Entity\Commentaire
 */
class Commentaire
{
    /**
     ...
     * Set filCmmentaires
     *
     * @param TDN\DocumentBundle\Entity\Document $filCmmentaires
     * @return Commentaire
     */
    public function setFilCmmentaires(\TDN\DocumentBundle\Entity\Document $filCmmentaires = null)
    {
     ...
     * Set filAuteur
     *
     * @param TDN\NanaBundle\Entity\Nana $filAuteur
     * @return Nana
     */
    public function setFilAuteur(\TDN\NanaBundle\Entity\Nana $filAuteur = null)
    {
     ...
     * Get filAuteur
     *
     * @return TDN\NanaBundle\Entity\Nana $filAuteur
     */
     ...
     * @return Document
     */
    public function setFilDocument(\TDN\DocumentBundle\Entity\Document $filDocument = null)
    {
     ...
     * Get filDocument
     *
     * @return TDN\DocumentBundle\Entity\Document $filDocument
     */
